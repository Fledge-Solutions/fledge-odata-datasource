...
func (client *clientMock) Get(_ context.Context, _ string, _ []property, _ []expandProperty, _ []filterCondition) (*http.Response, error) {
	return &http.Response{StatusCode: client.statusCode,
		Body: io.NopCloser(bytes.NewReader(client.body))}, client.err
}

func (client *clientMock) GetAggregated(_ context.Context, _ string, _ []property, _ []aggregateSpec, _ []filterCondition) (*http.Response, error) {
	return &http.Response{StatusCode: client.statusCode,
		Body: io.NopCloser(bytes.NewReader(client.body))}, client.err
}
