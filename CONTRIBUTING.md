# Contributing to the Fledge OData Data Source Plugin

Thank you for considering contributing to this project. It will help us to make this project more valuable for the
community.

This plugin is a fork of the [d-velop Grafana OData data source](https://github.com/d-velop/grafana-odata-datasource),
which laid the groundwork this project builds on. See the [Acknowledgments](README.md#acknowledgments) section of the
...
Instead, visit [fledge.nl](https://www.fledge.nl) and contact Fledge support.
...
You can file bug reports on the [issues page](https://github.com/fledge-solutions/fledge-odata-datasource/issues). Please name
this issue ``Bug: <SHORT_DESCRIPTION>``.

Please follow the following steps prior to filing a bug report.

1.  Search through existing [issues](https://github.com/fledge-solutions/fledge-odata-datasource/issues) to ensure that
...
You can submit feature requests on the [issues page](https://github.com/fledge-solutions/fledge-odata-datasource/issues).
