...
[npm](https://www.npmjs.com/) is used for managing and building the frontend and [Mage](https://magefile.org) for
the backend.
...
```bash
git clone https://github.com/fledge-solutions/fledge-odata-datasource.git
```
